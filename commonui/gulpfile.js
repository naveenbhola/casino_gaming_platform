 ...
 */
gulp.task('build', ['build-dev', 'optimize'], function() {
...
/**
 * Create a development/debug build
 * @return {Stream}
 */
gulp.task('build-dev', function() {
    return gulp
        ...
        .pipe($.concat('wdts-common-ui-client.js'))
...
gulp.task('optimize', ['test'], function() {
    ...
    return gulp
        ...
        .pipe($.ngAnnotate({add: true}))
        .pipe($.uglify())
        .pipe($.concat('wdts-common-ui-client.min.js'))
