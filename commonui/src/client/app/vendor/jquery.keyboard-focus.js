		...
		$(this)
			...
			.bind('focusin', function(e){
				...
				// works!
					...
					// this is to prevent false keyboard detections especially for the styled checkboxes
					if ($(this).data('last-device-used') == 'keyboard') {
						$(e.target).addClass($.keyFocus.conf.keyFocusClass);
					} else if ($(this).data('last-device-used') == 'mouse') {
						$(e.target).addClass($.keyFocus.conf.mouseFocusClass);
					}
